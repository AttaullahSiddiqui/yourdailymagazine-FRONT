    ...
    return new Promise((resolve, reject) => {
      ...
      switch (state.url) {
        case "/categories": {
          ...
          this.metaService.updateTag({ property: 'og:title', content: 'Categories' });
        ...
        case "/stores": {
          ...
          this.metaService.updateTag({ property: 'og:title', content: 'Stores' });
          this.metaService.updateTag({ name: 'description', content: 'Many Stores that provide you just according to your style. Embrace your style with our stores. Embrace your class with DigMyCart' });
          this.metaService.updateTag({ property: 'og:description', content: 'Many Stores that provide you just according to your style. Embrace your style with our stores. Embrace your class with DigMyCart' });
          break;
        }
        case "/blogs": {
        ...
        case "/products": {
          ...
          this.metaService.updateTag({ property: 'og:title', content: 'Products on DigMyCart' });
          break;
        }
        case "/home": {
          this.titleService.setTitle("DigMyCart | Home");
          this.metaService.updateTag({ name: 'description', content: 'Find all the latest coupons and promo codes of thousands of online stores for a hassle-free and convenient online shopping experience with digmycart.com. We provide the best ongoing deals to our global customers and strive hard to satisfy them in finding what they are searching for. Take a seat, sit back and relax while browsing through our website and get enlightened to massive discounts on luxurious brands. We have further categorized the website to make your shopping experience better. Shop high-end brands with coupons and promo codes with digmycart.com and see your dreams come true' });
          this.metaService.updateTag({ property: 'og:description', content: 'Find all the latest coupons and promo codes of thousands of online stores for a hassle-free and convenient online shopping experience with digmycart.com. We provide the best ongoing deals to our global customers and strive hard to satisfy them in finding what they are searching for. Take a seat, sit back and relax while browsing through our website and get enlightened to massive discounts on luxurious brands. We have further categorized the website to make your shopping experience better. Shop high-end brands with coupons and promo codes with digmycart.com and see your dreams come true' });
          this.metaService.updateTag({ property: 'og:title', content: 'Home' });
          break;
        }
        case "/event": {
          this.titleService.setTitle("Enjoy exquisite discount offers at special events only at DigMyCart.");
          this.metaService.updateTag({ name: 'description', content: 'Do you want to make the best out of the special days of the year? DigMyCart is here with amazing coupon codes, vouchers and discount deals to help you in it.' });
          this.metaService.updateTag({ property: 'og:description', content: 'Do you want to make the best out of the special days of the year? DigMyCart is here with amazing coupon codes, vouchers and discount deals to help you in it.' });
          this.metaService.updateTag({ property: 'og:title', content: 'Enjoy exquisite discount offers at special events only at DigMyCart.' });
          break;
        }
      }
      return resolve(true);
